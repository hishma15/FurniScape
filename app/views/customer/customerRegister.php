...
<?php include "../layout/header.php"?>
    ...
    <?php endif; ?>
        ...
        <!------------------------------------ REGISTER SECTION ------------------------------------------------------>
        <div class="absolute bg-beige/80 left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 p-8 rounded-lg shadow-lg w-full md:max-w-xl" id="registerForm">
        <!-- <div class="bg-beige/80 p-8 rounded-lg shadow-lg w-full max-w-lg hidden" id="registerForm"> -->
            <!-- REGISTER -->
             <div class="text-center">
                <span class="font-montserrat text-black tracking-wider">ALREADY HAVE AN ACCOUNT? 
                    <a href="customerLogin.php" onClick="changeForm()" class="hover:underline"> Login </a>
                </span>
             </div>
            ...
            <!-- <form action="../../../app/controllers/AuthController.php" id="register-form" method="POST"> -->
